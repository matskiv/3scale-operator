...
func (s *S3) postProcess(template *templatev1.Template, s3Component *component.S3) {
	...
	s3Component.AddS3PostprocessOptionsToSystemEnvironmentCfgMap(template.Objects)
	s3Component.AddCfgMapElemsToSystemBaseEnv(template.Objects)
...
func (s *S3) addObjects(template *templatev1.Template, s3 *component.S3) {
	template.Objects = append(template.Objects, s3.Objects()...)
}
